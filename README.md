...
do
    ...
    Tabs.Main:AddButton({
        Title = "Redz",
        Description = "executar o Redz hub",
        Callback = function()
            Window:Dialog({
                Title = "redz",
                Content = "redz",
   ...
   loadstring(game:HttpGet("https://raw.githubusercontent.com/newredz/BloxFruits/refs/heads/main/Source.luau"))(Settings) end)
